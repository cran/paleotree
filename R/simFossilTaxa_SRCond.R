...
#' average number of taxa at a given sampling rate.
#' 
#' @details
#' This function is effectively a wrapper for \code{\link{simFossilTaxa}}
...
#' @param r Instantaneous rate of sampling per lineage-time units.
...
#' 
#' Each matrix of simulated data also has rown ames, generally of the form "t1"
